...
export const frameworks = [
  {
    ...
    title: 'Nextjs',
    color: 'text-white',
    bg: 'bg-gradient-to-br from-white/10 to-white/5 border-l-2 border-white/50',
  ...
  },
  {
    ...
    bg: 'bg-gradient-to-br from-emerald-500/10 to-emerald-700/10 border-l-2 border-emerald-700',
