export default function WelcomeBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-l from-transparent to-green-500/10 glass-effect mb-8 mt-18 lg:mt-8 inset-shadow-xs inset-shadow-green-500/10">
