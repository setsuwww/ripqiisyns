export default function WelcomeBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-green-500/20 bg-gradient-to-l from-transparent to-green-500/10 glass-effect mb-8 mt-18 lg:mt-8">
